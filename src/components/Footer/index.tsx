...
const Footer = () => {
  ...
  const COLUMN_A = MAIN_MENU.slice(1, 5)
  const COLUMN_B = MAIN_MENU.slice(5, 9)
  const COLUMN_C = MENU_C.slice(0, 1)
  const BOTTOM_BAR = MENU_C.slice(1, 5)

  return (
    <footer className='footer bg-dark-blue dark:bg-neutral-800 relative text-sm text-slate-300'>
      <ButtonGoTop />
      <div className='bg-dark-blue dark:bg-neutral-800 text-xs'>
      ...
      <div className='bg-primary dark:bg-neutral-700 text-xs text-slate-300'>
