...
const SocialBanners = () => {
  ...
  return (
    <div
      className={`fixed right-4 bottom-28 z-50 w-80 rounded-xl border border-gray-100 bg-white p-4 font-sans shadow-xl transition-transform duration-300 ease-in-out md:bottom-40 dark:border-neutral-700 dark:bg-neutral-800 ${
