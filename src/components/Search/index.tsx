  ...
  return (
    <form onSubmit={handleSubmit} className='flex w-full font-sans'>
      <input
        ...
        placeholder='Buscar...'
        className='focus:border-primary focus:ring-primary w-full rounded-l-md border border-gray-300 bg-white px-2 py-1 text-slate-700 focus:ring-1 focus:outline-none dark:border-neutral-500 dark:bg-neutral-700 dark:text-neutral-300'
