  ...
  return (
    <section className='md:w-2/3 md:pr-8 lg:w-3/4'>
      <div className='-mx-6 flex flex-col space-y-3 sm:mx-0'>
        ...
        <div className='border-primary relative -top-14 z-2 mt-4 border-t-4 bg-white px-5 pt-4 sm:w-11/12 dark:bg-neutral-800'>
      ...
      <section className='flex flex-col pb-12 md:flex-row'>
        <div className='w-full md:w-3/5 md:pr-3 md:pl-5'>
          <div className='relative'>
            ...
            <div className='absolute -top-2 left-0 z-10 h-6 w-20 bg-white pl-2 md:top-auto md:-bottom-1 dark:bg-neutral-800'></div>
          </div>
          <div className='space-y-2 py-4'>
            <Skeleton className='h-4 w-11/12' />
            <Skeleton className='h-4 w-2/3' />
          </div>
          <hr className='relative mt-4 mb-3 w-2/3 text-slate-200 md:mt-0 lg:w-3/4 dark:border-neutral-500 dark:bg-neutral-300'></hr>
        </div>
