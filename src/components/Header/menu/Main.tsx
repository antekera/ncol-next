...
const MainMenu = () => {
  return (
    <div className='shadow-menu flex w-full items-center border-b border-solid border-slate-200 font-sans xl:shadow-none dark:border-neutral-500 dark:bg-neutral-800'>
      <Container
        className='scrolling-touch scrolling-auto scrollbar -ml-3 flex h-10 scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent flex-row space-x-1 overflow-auto text-sm sm:mx-auto md:justify-center'
        tag='nav'
      >
