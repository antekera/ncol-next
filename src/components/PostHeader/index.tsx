...
import { Date, Container } from 'components/'
...
const PostHeader = ({ title, date, categories }: PostHeaderProps) => {
  return (
    <Container>
      ...
      <h1 className='my-8 text-3xl sm:text-4xl leading sm:w-11/12 md:my-12 md:text-5xl lg:text-6xl font-sans_medium text-slate-700'>
        {title}
      </h1>
      <p className='mb-6 -mt-6 md:text-xl lg:text-2xl md:-mt-7 text-slate-500 md:mb-12 leading-6 sm:w-11/12 font-sans_light'>
        “It’s definitely a more complicated Olympics,” said American snowboarder
        Jamie Anderson.
      </p>
      <div className='flex w-full pb-2 text-sm text-slate-500 font-sans_light'>
        <div className='pr-2'>
